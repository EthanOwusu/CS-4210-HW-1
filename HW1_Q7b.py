#-------------------------------------------------------------------------
# AUTHOR: Ethan Owusu-Bour
# FILENAME: decision_tree.py
# SPECIFICATION: Reads contact lens file and creates a decision tree to determine whether a client to receive contact lenses
